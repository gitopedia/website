...
// Process markdown to HTML with KaTeX math support and GFM (footnotes, tables, etc.)
async function processMarkdown(content) {
  ...
  const processor = unified()
    .use(remarkParse)
    .use(remarkGfm) // GitHub Flavored Markdown: footnotes, tables, strikethrough, etc.
    .use(remarkMath) // Math equations with $ and $$
